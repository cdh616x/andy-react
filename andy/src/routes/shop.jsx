...
import stalker from "../../src/thumbnail-images/stalker.png";
...
export default function Shop() {
  return (
    <>
     ...
     <p className="shop-title">All prints $20 + shipping</p>
     <div className="row">
     ...
     <div className="row">
      ...
      <GalleryItem src={stalker} title="Stalker" print="8 x 8 || 6 x 6" herf="/ink-gallery/stalker" />
